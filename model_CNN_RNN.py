...
class HybridCNNandRNN(nn.Module):
    '''
    ...
    def __init__(self, input_shape_cnn, hidden_units_cnn, hidden_units_rnn, output_shape, num_layers_rnn):
        ...
        self.rnn_layer = nn.Sequential( #[batch_size, sequence length,input_size]
            nn.RNN(
    ...
    def forward(self, x):
        ...
        x, _ = self.rnn_layer(x) # [64, 1, 10] -> [batch_size, seq, hidden_units_rnn]
        x = self.seq_linear(x)
        return x
